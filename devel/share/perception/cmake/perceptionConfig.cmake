...
if("TRUE" STREQUAL "TRUE")
  set(perception_SOURCE_PREFIX /home/jerry/autonomous_ws/src/perception)
  set(perception_DEVEL_PREFIX /home/jerry/autonomous_ws/devel)
  ...
  set(perception_INSTALL_PREFIX /home/jerry/autonomous_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'perception' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jerry/autonomous_ws/src/perception/${idir}'.  ${_report}")
    endif()
...
set(depends "cv_bridge;image_transport;octomap_ros;roscpp;sensor_msgs;std_msgs;tf2;tf2_ros;nodelet;depth_image_proc")
